	...
	<form class="ui fluid form" action="${path}/join/join.do" method="post">
		...
		<div class="inline field">
			<input type="text" name="id" placeholder="아이디(4~19자 영어,숫자 포함)"
				style="width: 300px; height: 50px; border: 1px solid #174374;"
				onchange="iid(this)" required class="c">
			<div class="ui left pointing green basic label" id="idmsg"
				style="display: none; font-size: 15pt;"></div>
			<div class="ui left pointing red basic label" id="iderror"
				style="display: none; font-size: 15pt;"></div>
		</div>
		...
		<div class="inline field">
			<input type="password" onchange="ipw(this)" name="pass"
				...
				style="width: 300px; height: 50px; border: 1px solid #174374;"
				required>
			<div class="ui left pointing green basic label" id="pwmsg"
				style="display: none; font-size: 15pt;"></div>
		...
		<div>
			<c:forEach var="i" items="${map}">
				<div class="ui checkbox"
					...
					<input type="checkbox" value="${i.CATENAME }" onchange="gc(this)"
						name="job"> <label style="color: #0D2745">${i.CATENAME }</label>
		...
		<div class="inline field">
			<input type="text" name="nick" placeholder="닉네임(4~10 영어,한글 포함)"
				...
				style="width: 300px; height: 50px; border: 1px solid #174374;"
				required>
			<div class="ui left pointing green basic label" id="nickmsg"
				style="display: none; font-size: 15pt;"></div>
			<div class="ui left pointing red basic label" id="nickerror"
				style="display: none; font-size: 15pt;"></div>
		</div>

		<div class="inline field">
			<input type="text" type="email" onchange="em(this)" name="email"
				id="email" aria-descrivedby="emailHelp"
				placeholder="Sample@example.com"
				style="width: 300px; height: 50px; border: 1px solid #174374;"
				required>
			<div class="ui left pointing green basic label" id="emmsg"
				style="display: none; font-size: 15pt;"></div>
			<div class="ui left pointing red basic label" id="emerror"
				style="display: none; font-size: 15pt;"></div>
		</div>
		<div class="inline field">
		...
		<div class="inline field">
			<input type="text" onchange="phn(this)" name="phone"
				placeholder="XXX-XXXX-XXXX"
				style="width: 300px; height: 50px; border: 1px solid #174374;"
				required>
			<div class="ui left pointing green basic label" id="phmsg"
				style="display: none; font-size: 15pt;"></div>
			<div class="ui left pointing red basic label" id="pherror"
				style="display: none; font-size: 15pt;"></div>
		</div>
		<div>

			<button class="ui grey button" id="btnsubmit" disabled="disabled">회원
				가입</button>
		</div>
		<p>JOB GO ㏇</p>
