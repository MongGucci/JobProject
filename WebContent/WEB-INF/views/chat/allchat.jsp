			...
			<c:when test="${sessionScope.nick eq e.nick}">
				<div class="inline field" align="right" style="margin-bottom: 10px;">
					<div class="ui right pointing red basic label"
						style="font-size: 15pt;">${e.nick} : ${e.text}</div>
					<i class="user icon"
			...
			<c:otherwise>
				<div class="inline field" align="left" style="margin-bottom: 10px;">
					...
					<div class="ui left pointing black basic label"
						style="font-size: 15pt; color: #F4F4F4;">${e.nick} :
						${e.text}</div>
...
<div class="input-group mb-3">
	<div class="input-group-prepend">
		<span class="input-group-text" id="basic-addon1"
			...
			class="comment alternate outline icon" style="font-size: 15pt;"></i></span>
	</div>
...
<script type="text/javascript">
	...
	var allHandle = function(obj) {
		...
		if (mynick == obj.nick) {
			...
			html += "</div><i class=\"user icon\" style=\"font-size: 15pt; margin-right: 2px; color: #F14444; \" ></i></div>";
