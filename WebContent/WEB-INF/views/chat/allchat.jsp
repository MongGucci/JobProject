...
<hr />
<div>
	<span style="font-size: x-large; color: #434e6e; font-weight: bolder;">&nbsp;<i
		class="users icon" style="font-size: x-large; color: #434e6e;"></i>&nbsp;
		전체채팅 <span id="total" style="font-size: x-large; color: #434e6e;"></span></span>
</div>
<hr />
		...
		<c:choose>
			...
			<c:when test="${sessionScope.nick eq e.nick}">
				<div class="inline field" align="right" style="margin-bottom: 10px;">
					<div class="ui right pointing red basic label"
						style="font-size: 15pt; max-width: 70%;">${e.text}</div>
					<i class="user icon"
						style="font-size: 15pt; margin-right: 2px; color: #F14444;"></i>
				</div>
			...
			<c:otherwise>
				<div class="inline field" align="left" style="margin-bottom: 10px;">
					...
					<div class="ui left pointing black basic label"
						style="font-size: 15pt; color: #F4F4F4; max-width: 70%;">
						${e.nick} : ${e.text}</div>
...
<div class="input-group mb-3">
	<div class="input-group-prepend">
		<span class="input-group-text" id="basic-addon1"
			style="color: #434e6e; font-weight: bolder;">CHAT</span>
	</div>
...
<script type="text/javascript">
	$('#chatView').scrollTop(
			$('#chatView')[0].scrollHeight - $('#chatView')[0].clientHeight);
